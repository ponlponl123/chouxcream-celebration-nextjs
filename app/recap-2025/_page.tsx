        ...
        {contentIsReady && (
          <>
            <section
              ...
              className="h-max flex max-md:flex-col md:justify-center max-md:items-center w-full z-10 py-12 md:py-24 mt-12 px-4 gap-6 bg-black"
            >
            ...
            <section
              ...
              className="h-max flex max-md:flex-col md:justify-center max-md:items-center w-full z-10 py-12 mb-12 md:py-24 px-4 gap-6 bg-black"
            >
              <div className="mt-8 md:mt-12 w-full max-w-md flex justify-center">
                <img
                ...
                {[
                  ...
                  >
                    <motion.div
                      ...
                      onClick={() =>
                        setSelectedMemory({ name: item.name, img: item.img })
                      }
                    >
            ...
            <section
              key="section-stats"
              className="w-full py-12 bg-black/50 backdrop-blur-sm z-10"
            >
              <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                {[
                  { label: "Subscribers", value: "3.23K+" },
                  { label: "Videos", value: "551+" },
                  { label: "Streams", value: "608h+" },
                  { label: "Smiles", value: "∞" },
                ].map((stat, index) => (
                  <motion.div
                    key={index}
